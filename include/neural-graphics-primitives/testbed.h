...
public:
	...
	ivec3 compute_and_save_rgba_slices(const fs::path& filename, int res, BoundingBox aabb = {}, float depth = .01f, float density_range = 4.f, bool flip_y_and_z_axes = false);
